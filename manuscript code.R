...
xx[[1]]=comb70_t2[,1]; xx[[2]]=comb100_t2[,1];xx[[3]]=comb200_t2[,1];xx[[4]]=comb250_t2[,1];xx[[5]]=comb300_t2[,1];xx[[6]]=comb400_t2[,1];xx[[7]]=comb500_t2[,1];xx[[8]]=comb700_t2[,1]
yy[[1]]=comb70_t2[,2]; yy[[2]]=comb100_t2[,2];yy[[3]]=comb200_t2[,2];yy[[4]]=comb250_t2[,2];yy[[5]]=comb300_t2[,2];yy[[6]]=comb400_t2[,2];yy[[7]]=comb500_t2[,2];yy[[8]]=comb700_t2[,2]
...
#horizontalspeed=rbind(xx70,xx100,xx200,xx250,xx300,xx400,xx500,xx700)
#verticalspeed=rbind(yy70,yy100,yy200,yy250,yy300,yy400,yy500,yy700)
horizontalspeed = rbind(comb70_t2[,1],comb100_t2[,1],comb200_t2[,1],comb250_t2[,1],comb300_t2[,1],comb400_t2[,1],comb500_t2[,1],comb700_t2[,1])
verticalspeed = rbind(comb70_t2[,2],comb100_t2[,2],comb200_t2[,2],comb250_t2[,2], comb300_t2[,2],comb400_t2[,2],comb500_t2[,2],comb700_t2[,2])
...
s=scatterplot3d(horizontalspeed[,1],verticalspeed[,1],pressurelevel,type="p" ,
                ...
                xlab = "u-component", ylab = "v-component",zlab = "Pressure level",
                angle=20, color ="grey60", main="1987-2011")
dims <- par("usr")
...
############ combined plot for 200 and 300 #######################
par(oma = c(4, 1, 1, 1))
par(mfrow=c(1,2))
plot(comb200[,1], comb200[,2],col="grey60", pch=20, cex=0.3, main="1962-1986 (Pressure level 200)",
     xlab="Horizontal speed", ylab="Vertical speed",xlim=c(-85,120), ylim=c(-100,100))
...
plot(comb200[,1], comb200[,2],col="grey60", pch=20, cex=0.3, main="1962-1986 (Pressure level 300)",
     xlab="Horizontal speed", ylab="Vertical speed", type="n",xlim=c(-85,120), ylim=c(-100,100))
points(comb300[,1], comb300[,2],col="grey60", pch=20, cex=0.3)
polygon(int_dir_t1, border = "blue", lwd=2)
polygon(int_dir_hk_t1, border = "green", lwd=2)
polygon(int_dir_qr_t1, border = "red", lwd=2)
...
plot(0, 0, type = "n", bty = "n", xaxt = "n", yaxt = "n")
legend("bottom", lwd=2,
       legend=c("Estimated", "Kriging","Quantile regression"), bty="n",
       col = c("blue", "green", "red"), cex = 0.9, xpd = TRUE, horiz = TRUE, inset = c(0,0))
